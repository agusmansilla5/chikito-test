  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-5 shadow-sm">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-sm font-semibold text-zinc-900">Movimientos — últimos 7 días</h2>
      ...
      <div className="flex h-40 items-end gap-4 border-b border-zinc-100">
        {data.map((d) => (
      ...
      <div className="flex gap-4">
        {data.map((d) => (
          <div key={d.label} className="flex-1 pt-2 text-center text-xs capitalize text-zinc-500">
            {d.label}
          </div>
        ))}
      </div>
